...
submit.addEventListener("click", (e) => {
    ...
    newEle.innerHTML = `<div id="${titlec}"> 
    <p>${titlec} - ${descc} - ${info}  <button type="submit" class="btn btn-danger deletetn" onclick="myfunc('${titlec}')"> Delete</button>       <a class="btn btn-primary" href="#" role="button">Edit</a> </p>`;
    ...
    //     newEle.remove()
    //     localStorage.removeItem(titlec)
    // });
